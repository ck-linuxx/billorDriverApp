          ...
          <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
            <View className="h-full p-4 flex justify-center gap-3">
              <View className="bg-white p-4 rounded-lg">
                <View className="mb-3">
                  <Text className="text-titleAndButtons text-4xl font-extrabold">Welcome!</Text>
                  <Text className="text-blueLetters text-lg">
                    Please enter your details to sign up
                  </Text>
                </View>

                <View className="flex gap-2">
                  <Text className="text-blueLetters text-xl">Username:</Text>
                  <TextInput
                ...
                <View className="flex gap-2 mt-4 relative">
                  <Text className="text-blueLetters text-xl">Repeat password:</Text>
                  <TextInput
                    secureTextEntry={!passwordVisible}
                ...
                <View className="flex my-4 gap-6">
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate("login")}>
                    <Text className="text-blueLetters text-xl self-center">Already have an account?</Text>
                  </TouchableOpacity>
